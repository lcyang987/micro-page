<template>
	<div class="imageAdSidebar" v-if="result" >
		<div class="demo-tip-setting">
			...
			<p>
				<mu-radio label="折叠轮播" nativeValue="carousel" v-model="result.attr.type" class="demo-radio"/>
				<mu-radio label="分开显示" nativeValue="separate" v-model="result.attr.type" class="demo-radio"/>
			</p>
		</div>
